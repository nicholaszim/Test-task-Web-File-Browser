...
namespace WebDiskBrowser.Managers.Tests
{
	...
	public class FileSystemManagerTests
	{
		...
		{
			string expectedPath = @"Your valid path here";
		...
		public void ReturnFileSystemEntriesTest()
		{
			...
			var invalidPath5 = "C";
			var invalidPath6 = @"Your valid path here";
			FileSystemManager fs = new FileSystemManager();
		...
		{
			var path = @"Your valid path here";
			var path2 = "Your invalid path here";
			var path3 = @"Your invalid path here";
		...
		public void ReturnCountTest()
		{
			...
			// test method
			if (!Directory.Exists(@"Your valid path here\TestFolder\"))
			{
				Directory.CreateDirectory(@"Your valid path here\TestFolder\");
				File.Create(@"Your valid path here\TestFolder\testfile.txt");
				FileInfo fi = new FileInfo(@"Your valid path here\TestFolder\testfile.txt");
				var fileSize = fi.Length;

				FileSystemManager fs = new FileSystemManager();
				var count = fs.ReturnCount(@"Your valid path here\TestFolder", p => p.Length == fileSize);
